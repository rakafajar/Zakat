    ...
    <div class="col-md-8">
      <form action="{{ route('infaqshadaqah.store') }}" method="POST">
        ...
        <div class="form-group">
          ...
          <input type="text" class="form-control" name="nama_insha" placeholder="Contoh : Hamba Allah" required>
        </div>
        <div class="form-group">
          <label for="nominal">Nominal:</label>
          <input type="text" class="form-control" name="nominal_insha" placeholder="Rp." required>
        </div>      
