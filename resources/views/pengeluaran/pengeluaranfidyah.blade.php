...
<ol class="breadcrumb">
	...
	<li class="breadcrumb-item active">Pengeluaran Fidyah</li>
</ol>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <form action="{{ route('pengeluaranfidyah.store') }}" method="POST">
              {{ csrf_field() }}
              <div class="col-sm-6">
              ...
              <div class="col-sm-6">
                <div class="input-group mb-3">
                  ...
                  <input type="number" class="form-control" name="jml_peng_fidyah" value="" placeholder="Rp." required>
                </div>
              </div>
              <div class="col-sm-6">
                <div class="input-group mb-3">
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
                <form method="post" id="form-pengeluaranfidyah">
                  {!! csrf_field() !!}
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <?php $no++; ?>
                  <tr>
                    <td><input type="checkbox" name="id[]" value="{{ $list->id_peng_fidyah }}"></td>
                    <td>{{ $no }}</td>
                    <td>Rp. <?php echo format_uang($list->jml_peng_fidyah); ?></td>
                    ...
                    <th style="text-align: center;">
                        ...
                        <a href="{{ route('pengeluaranfidyah.edit', $list->id_peng_fidyah) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
...
<script type="text/javascript">
  ...
  function deleteAll(){
    if ($('input:checked').length<1) {
      ...
      $.ajax({
        url: "pengeluaranfidyah/hapus",
        type: "POST",
        data: $('#form-pengeluaranfidyah').serialize(),
