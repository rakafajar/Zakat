...
<address contenteditable>
	<p>ZISWAF<br>Infaq & Shadaqoh</p>
</address>
<table class="meta">
	<tr>
		<th><span contenteditable>Invoice #</span></th>
		<td>
			<span contenteditable>{{$pengeluaran->id_peng_insha}}</span>
		</td>
	</tr>
	<tr>
		<th>
...
<table class="inventory">
	...
	<tbody>
		<tr>
            ...
            <td>
                <span contenteditable>Rp. <?php echo format_uang($pengeluaran->jml_peng_insha); ?></span>
            </td>
		</tr>
	</tbody>
</table>
<table class="balance">
	<tr>
		...
		<td>
			<span>Rp. <?php echo format_uang($pengeluaran->jml_peng_insha); ?></span>
		</td>
	</tr>
</table>
@endsection