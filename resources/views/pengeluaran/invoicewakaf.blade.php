...
<table class="meta">
	<tr>
		...
		<td>
			<span contenteditable>{{$pengeluaran->id_peng_wakaf}}</span>
		</td>
	</tr>
	<tr>
		<th>
...
<table class="inventory">
	...
	<tbody>
		<tr>
            ...
            <td>
                <span contenteditable>Rp. <?php echo format_uang($pengeluaran->jml_peng_wakaf); ?></span>
            </td>
		</tr>
	</tbody>
</table>
<table class="balance">
	<tr>
		...
		<td>
			<span>Rp. <?php echo format_uang($pengeluaran->jml_peng_wakaf); ?></span>
		</td>
	</tr>
</table>
@endsection