        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <form method="post" id="form-pengeluaraninsha">
                  {!! csrf_field() !!}
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <?php $no++; ?>
                  <tr>
                    <td><input type="checkbox" name="id[]" value="{{ $list->id_peng_insha }}"></td>
                    <td>{{ $no }}</td>
                    <td>
                    ...
                    <th style="text-align: center;">
                      <a href="{{ URL::to('pengeluaraninsha/invoiceinsha/'.$list->id_peng_insha) }}" class="btn btn-success btn-sm"><i class="fas fa-print"></i></a>
                      <a href="{{ route('pengeluaraninsha.edit', $list->id_peng_insha) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
...
<script type="text/javascript">
	...
	function deleteAll(){
		if ($('input:checked').length<1) {
			...
			$.ajax({
				url: "pengeluaraninsha/hapus",
				type: "POST",
				data: $('#form-pengeluaraninsha').serialize(),
