...
<div class="card">
  <div class="card-header">Form Pengeluaran Fidyah</div>
  <div class="card-body">
    <div class="col-md-8">
      ...
      @endif
      <form action="{{ route('pengeluaranfidyah.update', $pengeluaran->id_peng_fidyah) }}" method="POST">
        {{ csrf_field() }} {{ method_field('PATCH')}}
        <div class="form-group">
            <label for="jml_pengeluaran">Total Pengeluaran :</label>
            <p>Rp.
                <?php
                echo format_uang($pengeluaran->jml_peng_fidyah); 
              ?>
            </p>
        </div>
        <div class="form-group">
        ...
        <a href="{{ route('pengeluaranfidyah.index') }}" class="btn btn-danger btn-sm"><i class="fas fa-arrow-circle-left"></i> Kembali</a>
      </form>
    </div>    
  </div>
</div>
