...
<div class="card">
  <div class="card-header">Pengeluaran Infaq & Shodaqoh</div>
  <div class="card-body">
    <div class="col-md-8">
      ...
      @endif
      <form action="{{ route('pengeluaraninsha.update', $pengeluaran->id_peng_insha) }}" method="POST">
        {{ csrf_field() }} {{ method_field('PATCH')}}
        <div class="form-group">
            <label for="jml_pengeluaran">Total Pengeluaran :</label>
            <p>Rp.
                <?php
                echo format_uang($pengeluaran->jml_peng_insha); 
              ?>
            </p>
        </div>
        <div class="form-group">
        ...
        <a href="{{ route('pengeluaraninsha.index') }}" class="btn btn-danger btn-sm"><i class="fas fa-arrow-circle-left"></i> Kembali</a>
      </form>
    </div>    
  </div>
</div>
