      ...
      <div class="col-md-8">
        ...
        <form action="{{ route('anggotakeluarga.update', $anggotakeluarga->id_anggotakk) }}" method="POST">
          ...
          <div class="form-group">
              ...
              <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" value="{{$anggotakeluarga->nama_lengkap}}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="{{$anggotakeluarga->tmp_lahir}}">
            </div>
            <div class="form-group">
              <label for="tgl_lahir">Tanggal Lahir:</label>
              <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="{{$anggotakeluarga->tgl_lahir}}">
            </div>
            <div class="form-group">
