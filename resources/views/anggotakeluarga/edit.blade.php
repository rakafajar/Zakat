        ...
        <form>
          <div class="form-group">
            ...
            <select class="form-control" id="kk" name="kk">
              ...
              <option value="{{ $list->kk_id }}">{{ $list->no_kk}}</option>
              @endforeach
            </select>
          </div> 
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="{{ $anggotakeluarga->tempat_lahir}}">
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="pekerjaan" name="pekerjaan" value="{{ $anggotakeluarga->pekerjaan}}">
          </div> 
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nama_ayah " name="nama_ayah" value="{{ $anggotakeluarga->nama_ayah}}">
          </div>
          <div class="form-group">
            <label for="nama_ibu ">Nama Ibu:</label>
            <input type="text" class="form-control" id="nama_ibu " name="nama_ibu" value="{{ $anggotakeluarga->nama_ibu}}">
          </div>     
